...
const navItems = [
  { href: "#", text: "Home" },
  { href: "#services", text: "Projects" },
  { href: "#about-us", text: "About Me" },
  { href: "#features", text: "Skills" },
];
export const Navbar = () => {
        ...
        <nav className="w-full flex justify-between gap-6 relative">
          ...
          <div
            className="flex flex-col lg:flex-row w-full lg:justify-between lg:items-center 
                ...
                border-x-box-border lg:border-x-0 lg:h-auto h-0 overflow-hidden"
          >
            <ul
            ...
            >
              <BtnLink text="Contact Me" href="#cta" className="" />
            </div>
          </div>
          <div className="min-w-max flex items-center gap-x-3">
            <button
              onClick={toggleTheme}
              className="outline-hidden flex relative text-heading-2 rounded-full p-2 lg:p-3 border-[1.5px] border-box-border cursor-pointer"
            >
              {theme === "dark" ? (
                <svg
                ...
                >
                  <path
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    d="M12 3v2.25m6.364.386-1.591 1.591M21 12h-2.25m-.386 6.364-1.591-1.591M12 18.75V21m-6.364-2.636 1.591-1.591M5.25 12H3m2.636-6.364 1.591 1.591M15.75 12a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0Z"
                  />
                </svg>
              )}
            </button>
